...
class VerifyEmailPage extends StatefulWidget {
  const VerifyEmailPage({super.key, required this.email, this.password = '', this.deliveryFailed = false});
  final String email;
...
class _VerifyEmailPageState extends State<VerifyEmailPage> {
  ...
  Future<void> _complete() async {
    ...
    try { await FirebaseEmailAuthFlow.completeVerification(); if (mounted) context.go('/home'); }
    catch (_) { if (mounted) AppPopup.show(context, message: 'Email chưa được xác thực. Hãy mở liên kết trong hộp thư rồi thử lại.', tone: AppPopupTone.warning); }
